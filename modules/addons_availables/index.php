 ...
 *   cambiar a otro módulo de Issabel, y volver y encontrar al módulo en el mismo
...
function do_iniciarInstallUpdate($smarty, $module_name, $local_templates_dir)
{
    ...
    $sid = $oAddons->getSID();
    if(is_null($sid)){
	$respuesta["error"] = _tr("Server id is not defined, you need to register your Issabel");
	return $json->encode($respuesta);
    }
